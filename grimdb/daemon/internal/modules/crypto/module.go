...
import (
	...
	enginecrypto "github.com/grimlocker/grimdb/engine/crypto"
...
type derivePayload struct {
	...
	Salt     []byte     `json:"salt"`
	Opts     enginecrypto.KDFOptions `json:"opts"`
}
...
func NewModule(p enginecrypto.Provider, kr KeyResolver) *Module {
